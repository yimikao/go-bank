...
migrateup: ; migrate -path db/migration -database "postgresql://root:secret@localhost:5431/go_bank?sslmode=disable" -verbose up

migratedown: ; migrate -path db/migration -database "postgresql://root:secret@postgrescontainer:5432/go_bank?sslmode=disable" -verbose down

migrateup1: ; migrate -path db/migration -database "postgresql://root:secret@postgrescontainer:5432/go_bank?sslmode=disable" -verbose up 1

migratedown1: ; migrate -path db/migration -database "postgresql://root:secret@postgrescontainer:5432/go_bank?sslmode=disable" -verbose down 1
